...
WHERE (cdrs.superresseler_id =".$r[0]." ) AND cdrs.start_stamp BETWEEN CURDATE()+INTERVAL -1 MONTH AND SUBTIME( CONCAT(CURDATE(), ' 00:00:00'),'00:00:01') AND cdrs.`isdaily`=2 GROUP BY cdrs.`numberrange_name`,cdrs.`superresrate`,cdrs.`Addon`
		";
