...
$conditonOnTerm="cdrs.isdaily=$payment_term and";	
          ...
          if ($this->Auth->user('role_id') == 2) {
               ...
               if ($subcustomer == -1 && $destination == -1) {
                    ...
                    $query = $query . " WHERE $conditonOnTerm cdrs.resseller_id=" . $subcustomer . " and (cdrs.superresseler_id = " . $this->Auth->user('id') . " ) and cdrs.start_stamp BETWEEN " . "'" . $start . "'" . " and " . "'" . $end . ":59'" . " GROUP BY cdrs.destination_number, cdrs.superresseler_id,cdrs.isdaily,cdrs.`superresrate`,cdrs.`Addon`, cdrs.resseller";
               } else if ($subcustomer != -1 && $destination != -1) {
