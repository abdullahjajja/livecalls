...
//          echo ($row); exit;
     ...
     function csvcalllogfromcds()
     {
          ...
          $query = "select caller_id_name,destination_number,operator_ip,start_stamp from cdrs where cdrs.billsec = 0 and answer_stamp='0000:00:00 00:00:00' and cdrs.destination_number not in (select dids.did from dids) and cdrs.start_stamp BETWEEN DATE_SUB(NOW(), INTERVAL 1 DAY) AND NOW();";
          $data = mysql_query($query) or mysql_error();
