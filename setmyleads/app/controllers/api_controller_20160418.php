...
$conditonOnTerm="cdrs.isdaily=$payment_term and";	
          ...
          // if resseller viewing calls
               ...
               if ($subcustomer == -1 && $destination == -1) {
                    ...
                    $query = $query . " WHERE cdrs.numberrange_name=" . "'" . $destinationtxt . "'" . " and (cdrs.resseller_id= " . $this->Auth->user('id') . " ) and cdrs.start_stamp BETWEEN " . "'" . $start . "'" . " and " . "'" . $end . ":59'" . " GROUP BY cdrs.destination_number,cdrs.isdaily,cdrs.`Addon`";
               } else if ($subcustomer != -1 && $destination == -1) {

                    $query = $query . " WHERE cdrs.subresseller_id=" . $subcustomer . " and (cdrs.resseller_id= " . $this->Auth->user('id') . ") and cdrs.start_stamp BETWEEN " . "'" . $start . "'" . " and " . "'" . $end . ":59'" . " GROUP BY cdrs.destination_number,cdrs.isdaily,cdrs.`Addon`";
               } else if ($subcustomer != -1 && $destination != -1) {
                    $query = $query . " WHERE cdrs.subresseller_id=" . $subcustomer . " and cdrs.numberrange_name=" . "'" . $destinationtxt . "'" . " and (cdrs.resseller_id= " . $this->Auth->user('id') . " ) and cdrs.start_stamp BETWEEN " . "'" . $start . "'" . " and " . "'" . $end . ":59'" . " GROUP BY cdrs.destination_number,cdrs.isdaily,cdrs.`Addon`";
               }
