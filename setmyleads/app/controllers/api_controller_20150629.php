...
//App::import('Controller', 'reports');
     ...
     function export_operators_weekly_report() {
          ...
          $latest_filename = 'operators_weekly_report.csv';
          $downloadfilename= 'operators_weekly_report_'.$startdate.'_to_'.$enddate.'.csv';
//          echo $file;
...
//          echo $file;
     ...
     function export_users() {
          ...
          $query = "SELECT login,users.`password`,first_name, last_name ,email ,phone ,users.`add_on`,created , modified FROM users ";
          $query2 = "
               SELECT login,'password',first_name, last_name ,email ,phone ,`add_on`,`created`,`preference`,MAX(USD) AS USD,MAX(EURO) AS  EURO,MAX(GBP) AS GBP ,w AS 'WesternUnion/MoneyGram Detail',p AS 'Payoneer Detail'
FROM (SELECT login,users.`password`,first_name, last_name ,email ,phone ,users.`add_on`,users.`created`,users.`preference`,
(
    CASE
...
numberranges.`sellingrate` AS WeeklyRate, numberranges.`dailyrate` AS DailyRate
FROM dids
JOIN numberranges ON numberranges.`id`=dids.`numberrange_id`
...
$conditonOnTerm="cdrs.isdaily=$payment_term and";	
          ...
          $query = "select cdrs.caller_id_name,cdrs.operator_name, cdrs.caller_id_number, cdrs.destination_number, cdrs.start_stamp, cdrs.billsec , cdrs.answer_stamp, cdrs.numberrange_name,cdrs.isdaily from cdrs ";
          $querycount = "select count(*) as totalcalls from cdrs ";
          ...
          $strCalls = "<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"10\"><tr><td align=\"left\" valign=\"top\">" .
                  ...
                  "<td class=\"gridtableHeader\"><table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">" .
                  "<tr>" .
                  "<td width=\"14%\" align=\"left\" style=\"padding-left:10px;\">Date/Time</td>" ;
                  if($this->Auth->user('role_id') == 1)
               { 
                $strCalls= $strCalls.   "<td width=\"14%\" align=\"left\" style=\"padding-left:10px;\">Operator Name </td>";
               }    
                $strCalls= $strCalls.   "<td width=\"14%\" align=\"left\" style=\"padding-left:10px;\">Destination Group</td>" .
                  "<td width=\"14%\" align=\"left\" style=\"padding-left:10px;\">Payment Term</td>" .
                  "<td width=\"14%\" align=\"left\" style=\"padding-left:10px;\">Caller</td>" .
                  "<td width=\"10%\" align=\"left\" style=\"padding-left:10px;\">Called</td>" .
	...
	break;
                    ...
                    $strCalls = $strCalls . "<tr" . $class . "><td class=\"grid1light\"><table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">" .
                            "<tr>" .
                            "<td width=\"14%\" align=\"left\" style=\"padding-left:10px;\" class=\"gridcellborder\">" . $call['cdrs']['answer_stamp'] . "</td>" ;
                            if($this->Auth->user('role_id') == 1)
                    {
						 $strCalls = $strCalls . "<td width=\"14%\" align=\"left\" class=\"gridcellborder\" style=\"padding-left:10px;\">" . $call['cdrs']['operator_name']. "</td>";
					}
                       $strCalls = $strCalls .     "<td width=\"14%\" align=\"left\" class=\"gridcellborder\" style=\"padding-left:10px;\">" . $call['cdrs']['numberrange_name'] . " </td>" .
                             "<td width=\"14%\" align=\"left\" class=\"gridcellborder\" style=\"padding-left:10px;\">" . $paymentTermText . "</td>" .
                            "<td width=\"14%\" align=\"left\" style=\"padding-left:10px;\" class=\"gridcellborder\">" . $call['cdrs']['caller_id_number'] . "</td>" .
                            "<td width=\"10%\" align=\"left\" style=\"padding-left:10px;\" class=\"gridcellborder\">" . $call['cdrs']['destination_number'] . "</td>" .
          ...
          $strCalls = "<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"10\">" .
               ...
               { 
                $strCalls= $strCalls.   "<td width=\"14%\" height=\"29px\" align=\"left\" style=\"padding-left:10px;\">Operator Name </td>";
                 ...
                 $strCalls= $strCalls.  "<td width=\"14%\" height=\"29px\" align=\"left\" style=\"padding-left:10px;\">Number Range </td>" .
                  "<td width=\"14%\"  height=\"29px\" align=\"left\" style=\"padding-left:10px;\">Number </td>" .
                  "<td width=\"14%\" height=\"29px\" align=\"left\" style=\"padding-left:10px;\">Payment Terms</td>" .
