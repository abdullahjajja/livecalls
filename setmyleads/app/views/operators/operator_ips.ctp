...
<script>
$(function() {
$(".primary_checkbox").on('change',function() {

     var theData = this.value.split("_");
      $.ajax({
               url: "../../api/primary_ip_set",
               type: "GET",
               data: {'ip' : theData[1], 'oper_id' : theData[0], 'isprimary' : this.checked},
                                             ...
                                             <tr>
                                                  <td class="gridtableHeader"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            <tr>
                                                                 ...
                                                                 <td width="20%" align="left" style="padding-left:30px;"><?php echo ('Operator Name'); ?></td>

                                                                 <td width="30%" align="center"><?php __('Created at'); ?></td>
                                                                 <td width="10%" align="center"><?php __('Primary'); ?></td>
                                                  ...
                                                  <tr<?php echo $class; ?>>
                                                       <td ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                 ...
                                                                 echo $operator['operator_ips']['ip'];  ?></td>
                                                                      <td width="20%" align="left" class="gridcellborder" style="padding-left:20px;"><?php echo $operator['operators']['name']; ?></td>
                                                                      <td width="30%" align="center" class="gridcellborder">
                                                                          <?php echo $operator['operator_ips']['created_at']; ?>
                                                                      </td>
                                                                      <td width="10%" class="gridcellborder"><input class="primary_checkbox" type="checkbox" name="primaryip"  value="<?php echo $operator['operator_ips']['operator_id']. '_' .$operator['operator_ips']['ip']; ?>" <?php if($operator['operator_ips']['isprimary'] == 1){echo 'checked';} ?>></td>
                                                                      <td width="10%" class="gridcellborder"><?php echo $this->Html->link(__('delete', true), array('action' => 'delete_op_ip',  $operator['operator_ips']['id'], '?' => array('oper_id' => $oper['Operator']['id'], 'oper_ip_id' => $operator['operator_ips']['id']))); ?></td>
                                                                 </tr>
                                                            </table></td>
                                                  </tr>
                                             <?php
