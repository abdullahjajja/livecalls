                                                            ...
                                                            <td <?php echo $class; ?>><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                      <tr>
                                                                           ...
                                                                           <td width="15%" align="right" class="gridcellborder"> &nbsp;
                                                                                <span onclick="approve(<?php echo $notification['Numberrange']['id'] ?>,<?php echo $notification['User']['id'] ?>,<?php echo $notification['Notification']['isdaily'] ?>,this)"  style="cursor:pointer"> <a><img id="loading" src="./img/loading2.gif" height="25" width="35" style="display:none; float: left;" id="loading" />Approve </a></span> &nbsp;
