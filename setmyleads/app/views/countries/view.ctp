...
<div class="related">
	...
	<?php
		...
		<tr<?php echo $class;?>>
			...
			<td class="actions">
				<?php echo $this->Html->link(__('View', true), array('controller' => 'states', 'action' => 'view', $state['id'])); ?>
				<?php echo $this->Html->link(__('Edit', true), array('controller' => 'states', 'action' => 'edit', $state['id'])); ?>
				<?php echo $this->Html->link(__('Delete', true), array('controller' => 'states', 'action' => 'delete', $state['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $state['id'])); ?>
			</td>
		</tr>
	<?php endforeach; ?>
	</table>
