...
<div  id="maincontent">
     ...
     <div class="mainheading">
          <div align="left" style="float:left;">Users List</div>
          <div align="right" style="float:right;" >
          <?php if ($session->read('Auth.User.role_id') == '1') { 
               echo $this->Html->link(__('Deactivated Users', true), array( 'action' => 'deactivate'));    
               echo $this->Html->link(__('Export', true), array('controller' => 'api', 'action' => 'export_users')); ?>
          <?php }
