                                                            ...
                                                            //die(print_r($did));
                                                                 ...
                                                                 if ($i == 1) {
																	...
																	<?php } ?>
                                                                      ...
                                                                      { echo $this->Html->image('new.gif'); } echo " ".$dids[$j]['numberranges']['name'];
                                                                       ?>
                                                                                     ...
                                                                                     <td width="8%" align="right" style="padding-right:10px;" class="gridcellborder"><?php echo $dids[$j]['numberranges']['sellingrate']; ?></td>
                                                                                     <td width="8%" align="right" style="padding-right:10px;" class="gridcellborder"><?php echo $dids[$j]['numberranges']['monthlyrate']; ?></td>
