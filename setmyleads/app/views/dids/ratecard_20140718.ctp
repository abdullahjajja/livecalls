                                                  ...
                                                  <td class="gridtable"><table width="950px" border="0" cellspacing="0" cellpadding="0">
                                                            <tr>
                                                                 <td width="50%"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="gridtableHeader">
                                                                           <tr>
                                                                                <td width="18%" align="left"><?php echo ('&nbsp;Numberrange'); ?></td>
                                                                                <td width="15%" align="left"><?php echo ('Test Numbers'); ?></td>
                                                                                ...
                                                                                <td width="8%" align="center"><?php echo ('Daily Rate'); ?></td>
                                                                                <td width="10%" align="center"><?php echo ('Weekly Order'); ?></td>
                                                                                <td width="10%" align="center"><?php echo ('Daily Order'); ?></td>
                                                                           </tr></table></td>
                                                                 <td width="50%"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="gridtableHeader">
                                                                           <td width="18%" align="left"><?php echo ('&nbsp;Numberrange'); ?></td>
                                                                           <td width="15%" align="left"><?php echo ('Test Numbers'); ?></td>
                                                  ...
                                                  if ($i == 1) {
                                                       ...
                                                       <tr valign = "top">
                                                            <td width="50%"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="gridtable">
                                                                 ...
                                                                 $buy_curname = $getcurrency->getcurrencyNameById($did['Didrate'][0]['currency_id']);
                                                                 ?>
                                                                 <tr <?php echo $class; ?>>
                                                                      <td width="18%" align="left" class="gridcellborder" style=\"padding-left:10px;\">&nbsp;
                                                                           <?php echo $did['Numberrange']['name']; ?>
                                                                      </td>
                                                                      <td width="15%" align="left" class="gridcellborder"><?php echo $did['Did']['did']; ?></td>
                                                                      <td width="8%" align="center" class="gridcellborder"><?php echo $buy_curname; ?></td>
                                                                      <td width="8%" align="left" class="gridcellborder" style=\"padding-left:10px;\">
                                                                           <?php echo $did['Did']['maxdailyminutes']; ?>
                                                                      </td>
                                                                      <td width="8%" align="center" class="gridcellborder"><?php echo $did['Didrate'][0]['superresrate']; ?></td>
                                                                      <td width="8%" align="center" class="gridcellborder"><?php echo $did['Numberrange']['dailyrate']; ?></td>
                                                                      <td width="10%" align="center" class="gridcellborder"  style="cursor:pointer" onclick='autoorder(<?php echo $did['Numberrange']['id'] ?>, 0)'><?php echo $this->Html->image('week.png') ?></td>
                                                                      <td width="10%" align="center" class="gridcellborder" style="cursor:pointer"  onclick='autoorder(<?php echo $did['Numberrange']['id'] ?>, 1)'><?php echo $this->Html->image('day.png') ?></td>
