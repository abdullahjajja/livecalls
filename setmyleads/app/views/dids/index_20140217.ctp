...
//	if($authUser != '1') {	
	     echo $this->Form->input('currency_id',array('empty' => true, 'type'=>'select','label'=>'&nbsp;Currency','options'=>$currencies, 'style'=>'margin-left:10px;margin-top:5px;width:70px;height:20px;'));
//	}
...
//            echo $this->Form->lable("Buying Rate");
	...
	if($authUser == '1') { 
	    echo $this->Form->input('ivr_id', array('label'=>'&nbsp;IVR','type'=>'select','options'=>array('Select IVR') + $Ivrs,'default'=>' ','style'=>'margin-left:10px;margin-top:5px;width:122px;height:20px')); 
	}
	    ...
	    echo $this->Form->button('bt-assign.png', array('type'=>'button', 'style'=>'float:left;margin-left:10px;margin-top:2px;', 'id'=>'btndelete', 'name'=>'btndelete','onclick'=>'return validdel()'));
  ...
  <!--                      <td width="5%" align="center"><?php echo ('&nbsp;CLI Limit&nbsp;');?></td> -->
                        <td width="10%" align="center"><?php echo ('IVR');?></td> 
