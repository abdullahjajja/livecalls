...
//alert(nmbselected);
          //window.location = ("http://108.178.8.199/livecalls/dids/index?id=" + nmbselected);
...
<div  id="maincontent">
     <div class="mainheading"><div align="left">DIDs List</div> <?php if ($authUser == '1') { ?>
               <div align="right" style="margin-top: -17px; margin-right:160px;" >  <?php
                    if ($authUser == '1') {
                         echo $this->Form->button('Delete', array('type' => 'button', 'id' => 'btndelete', 'name' => 'btndelete', 'onclick' => 'return validdel()'));
                    }
                    ?></div>
               <div align="right" style="margin-top: -20px; margin-right:75px;" >  <?php echo $this->Html->link(__('Import', true), array('action' => 'uploaddid')); ?></div>
               <div align="right" style="margin-top: -18px" ><?php echo $this->Html->link(__('Add New', true), array('action' => 'add')); ?></div> <?php } ?> </div>
