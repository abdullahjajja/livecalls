...
<div  id="maincontent">
     ...
     <div align="right" style="margin-top: -18px; margin-right:420px; cursor:pointer;" id="del_orph_rec" onclick="return delete_orphan_records()">Del. orphan Dids</div>
               ...
               <div align="right" style="margin-top: -18px; margin-right:355px; cursor:pointer;" id = "btndelete" onclick="return validdel()">  <?php
                    if ($authUser == '1') {
               ...
               <a href = "/api/export_dids" style="">Export CSV </a>
...
//		print_r($did);
                                                                      ...
                                                                      <?php if ($authUser == '1') { ?>
                                                                           <td width="5%" align="right" style="padding-right: 5px;"  class="gridcellborder"><?php echo (float)$did['Didrate'][0]['adminbuyrate']; ?></td>
                                                                           <td width="5%"  align="right" style="padding-right: 5px;" class="gridcellborder"><?php echo (float)$did['Didrate'][0]['superresrate']; ?></td>
