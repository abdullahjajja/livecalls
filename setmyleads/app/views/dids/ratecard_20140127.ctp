				  ...
				  <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
					  <td class="gridtableHeader"><table width="100%" border="0" cellspacing="0" cellpadding="0">
					    <tr>
						<td width="12%" align="left" style=\"padding-left:10px;\"><?php echo ('&nbsp;Numberrange');?></td>
						<td width="12%" align="center"><?php echo ('Test Numbers');?></td>
						<td width="7%" align="center"><?php echo ('Curr');?></td>
						<td width="7%" align="center"><?php echo ('Rate');?></td> 
...
<?php		}
	...
	?>               
		<td width="12%" align="left" class="gridcellborder" style=\"padding-left:10px;\">&nbsp;
		<?php echo $did['Numberrange']['name']; ?>
		</td>
		<td width="12%" align="center" class="gridcellborder"><?php echo $did['Did']['did'] ; ?></td>
		<td width="7%" align="center" class="gridcellborder"><?php echo $buy_curname ; ?></td>
