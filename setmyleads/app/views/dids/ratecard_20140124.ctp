	   ...
	   <div class="maincenterBg" id="maintbl">
		...
		<tr valign="top">                                    
			<td width="50%">	
				...
				<td width="30%" align="left" style=\"padding-left:10px;\"><?php echo ('&nbsp;Numberrange');?></td>
				<td width="30%" align="center"><?php echo ('Test Numbers');?></td>
				<td width="15%" align="center"><?php echo ('Curr');?></td>
				<td width="15%" align="center"><?php echo ('Rate');?></td> 
				<td width="10%" align="center"><?php echo ('Limit');?></td>
...
//		echo "(($half))";
	...
	<?php } ?>
	  ...
	  <td <?php echo $class;?>><table width="100%" border="0" cellspacing="0" cellpadding="0" >
		...
		<td width="15%" align="center" class="gridcellborder"><?php echo $buy_curname ; ?></td>
		<td width="15%" align="center" class="gridcellborder"><?php echo $did['Didrate'][0]['superresrate']; ?></td>
