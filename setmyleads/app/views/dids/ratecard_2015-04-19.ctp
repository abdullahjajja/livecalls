                                                                      ...
                                                                      <tr valign = "top">
                                                                           <td width="100%"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="gridtable">
                                                                                ...
                                                                                <tr <?php echo $class; ?>>
                                                                                     ...
                                                                                     <td width="15%" style="padding-right:10px;" align="right" class="gridcellborder"><?php echo $did['dids']['did']; ?></td>
                                                                                     <td width="8%" align="left" style="padding-left:10px;" class="gridcellborder"><?php echo $did['currencies']['currency_name']; ?></td>
                                                                                     ...
                                                                                     <td width="8%" align="right" style="padding-right:10px;" class="gridcellborder"><?php echo $did['numberranges']['sellingrate']; ?></td>
                                                                                     <td width="8%" align="right" style="padding-right:10px;" class="gridcellborder"><?php echo $did['numberranges']['monthlyrate']; ?></td>
