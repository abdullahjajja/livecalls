																	...
																	?>
                                                                                ...
                                                                                <tr <?php echo $class; ?>>
                                                                                     <td width="15%" align="left" class="gridcellborder" >&nbsp;
                                                                                          <?php echo $dids[$i - 1]['numberranges']['name']; ?>
                                                                                     </td>
                                                                                     <td width="15%" style="padding-right:10px;" align="right" class="gridcellborder"><?php echo $dids[$i - 1]['dids']['did']; ?></td>
                                                                                     <td width="8%" align="left" style="padding-left:10px;" class="gridcellborder"><?php echo $dids[$i - 1]['currencies']['currency_name']; ?></td>
                                                                                     <td width="8%" align="right" style="padding-right:10px;" class="gridcellborder" style=\"padding-left:10px;\">
                                                                                          <?php echo $dids[$i - 1]['numberranges']['maxdailyminutes']; ?>
                                                                                     </td>
                                                                                     <td width="8%" align="right" style="padding-right:10px;" class="gridcellborder"><?php echo $dids[$i - 1]['numberranges']['sellingrate']; ?></td>
                                                                                     <td width="8%" align="right" style="padding-right:10px;" class="gridcellborder"><?php echo $dids[$i - 1]['numberranges']['monthlyrate']; ?></td>
                                                                                <input type="hidden" value="<?php echo $dids[$i - 1]['numberranges']['name']; ?>" id="<?php echo $dids[$i - 1]['numberranges']['id']; ?>"></input>
                                                                                <td width="18%" align="center" class="gridcellborder"  style="cursor:pointer" onclick='autoorder(<?php echo $dids[$i - 1]['numberranges']['id'] ?>, 0)'> <div style="margin-left: 20px; width: 117px;" class="green-button">Req. With <?php if($did['numberranges']['weekly_title']==NULL)
                                                                       	  echo 'Weekly 7/7';
																	    else echo $dids[$i - 1]['numberranges']['weekly_title'];
                                                                           	 ?>
                                                                               </div></td>
                                                                                <td width="18%" align="center" class="gridcellborder" style="cursor:pointer"  onclick="autoorder(<?php echo $dids[$i - 1]['numberranges']['id'] ?>, 2)">  <div style="margin-left: 20px; width: 117px;" class="green-button">Req. With 
                                                                          <?php if($dids[$i - 1]['numberranges']['monthly_title']==NULL)
                                                                       	  echo 'Monthly 30/30';
																	    else echo $dids[$i - 1]['numberranges']['monthly_title'];
                                                                           	 ?></div>    	
                                                                                </td>
