...
<div  id="maincontent">
     <div class="mainheading"><div align="left">DIDs List</div> <?php if ($authUser == '1') { ?>
               <div align="right" style="margin-top: -18px; margin-right:190px;" >  <?php echo $this->Html->link(__('Add IP', true), array('controller' => 'ips', 'action' => 'index')); ?></div>
               <div align="right" style="margin-top: -18px; margin-right:155px;" id = "btndelete" onclick="return validdel()" style="cursor:pointer">  <?php
                    if ($authUser == '1') {
                    ...
                    ?></div>
               <div align="right" style="margin-top: -18px; margin-right:75px;" >  <?php echo $this->Html->link(__('Import', true), array('action' => 'uploaddid')); ?></div>
