...
<div id="numb"></div>
           ...
           <?php echo $this->Form->input('assign_to', array('label'=>'&nbsp;Assign To','type'=>'select','options'=>$users, 'style'=>'margin-left:10px;margin-top:5px;width:122px;height:20px')); 
            echo $this->Form->input('currency_id',array('type'=>'select','label'=>'&nbsp;Currency','options'=>$currencies, 'style'=>'margin-left:10px;margin-top:5px;width:70px;height:20px;'));
...
//            echo $this->Form->lable("Buying Rate");
	    ...
	    echo $this->Form->input('sellrate',array('label'=>'&nbsp;Selling Rate&nbsp;&nbsp;','class'=>'inputbox132px','style'=>'width:35px;height:20px;'),array('id' => 'txtselling'));
            echo $this->Form->input('ivr_id', array('label'=>'&nbsp;IVR','type'=>'select','options'=>$Ivrs, 'style'=>'margin-left:10px;margin-top:5px;width:122px;height:20px')); 
    ...
    <div class="mainheading"><div align="left">DIDs List</div> <?php if($authUser == '1') {   ?> <div align="right" style="margin-top: -15px; margin-right:75px;" ><?php echo $this->Html->link(__('Import', true), array('action' => 'uploaddid')); ?></div><div align="right" style="margin-top: -15px" ><?php echo $this->Html->link(__('Add New', true), array('action' => 'add')); ?></div> <?php } ?> </div>
	   <div class="maincenterBg" id="maintbl">
			...
			<td width="10%" align="center"><?php echo ('Did');?></td>
                       <td width="5%" align="center"><?php echo ('Currency');?></td>
			...
			<?php if($authUser != '4') { 
                        echo  "<td width=\"10%\" align=\"left\" style=\"padding-left:10px;\"> Assigned To</td>";
                        } ?>
                        <?php if($authUser == '1') {   ?>
                        <td width="5%" align="center"><?php echo ('Daily Limit');?></td>
                       
                        <td width="5%" align="center"><?php echo ('&nbsp;CLI Limit&nbsp;');?></td>
                        <td width="15%" align="center"><?php echo ('Last Used Stamp');?></td> 
			<td width="15%" align="center"><?php __('Actions');?></td>
                        <?php } ?>
...
?>
		...
		<td width="10%" align="center" class="gridcellborder"><?php echo $did['Did']['did'] ; ?></td>
                ...
                <td width="5%" align="center" class="gridcellborder"><?php echo $curname; ?></td>
                 <?php if($authUser == '1')  {?>
		...
		<?php } ?>
                 <?php if($authUser != '4') { 
		echo "<td width=\"10%\" align=\"left\" class=\"gridcellborder\" style=\"padding-left:10px;\">".$assignedto."</td>";
		...
		<?php echo $did['Did']['perclilimit']; ?>         
                 ...
                 <td width="15%" align="left" class="gridcellborder" style=\"padding-left:10px;\">
		<?php echo $did['Did']['last_used']; ?>         
                </td> 
                
		<td width="15%" align="center" class="gridcellborder">				
