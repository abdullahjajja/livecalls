...
<html xmlns="http://www.w3.org/1999/xhtml">
     <head>
          ...
          <title><?php echo $operatorInvoice['Operator']['name'] .'-'. $operatorInvoice['OperatorInvoice']['id']; ?></title>
               ...
               <div class="over01">
                    ...
                    <div class="obj02">
                         ...
                         if ($operatorInvoice['Operator']['isweekly'] == 0) {
                              ...
                              $tp = date("d/m/y", strtotime($operatorInvoice['OperatorInvoice']['date'] . "-1 month")) . ' - ' . $ed->modify('last day of previous month')->format('d/m/y');
