...
<?php if($userid == 1) { ?>
                              <tr>
                                ...
                                <td>&nbsp;</td>
				<td>
           <a href="#" onclick="getadmincdrs(0);"><?php echo $this->Html->image('bt-search.png', array('alt'=> __('numberrange', true), 'width'=>'107', 'height'=>'28')); ?></a>  <a href="#" onclick="admindownload();" ><?php echo $this->Html->image('bt-download.png', array('action'=>'download'), array('alt'=> __('numberrange', true), 'width'=>'107', 'height'=>'28')); ?>
</a>
<img src="/livecalls/img/loading.gif" width="20" height="20" style="display:none" id="loading" />
<div style="display:none;" id="links">
<?php
