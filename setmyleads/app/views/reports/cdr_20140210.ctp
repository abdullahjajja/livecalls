...
<script src="http://108.178.8.202/setmyleads/app/webroot/js/jquery.ui.timepicker.js" type="text/javascript"></script>
<script src="http://108.178.8.202/setmyleads/app/webroot/js/jquery.timePicker.min.js" type="text/javascript"></script>
<link rel="stylesheet" href="http://108.178.8.202/setmyleads/app/webroot/js/timePicker.css" type="text/css" media="all" />

<script type="text/javascript" src="http://108.178.8.202/setmyleads/app/webroot/js/paging.js"></script>
<script type="text/javascript" src="http://108.178.8.203/livecalls/app/webroot/js/oneSimpleTablePaging-1.0.js"></script>
...
<?php echo $html->link('Download File', array(
'controller' => 'api',
'action' => 'download',
