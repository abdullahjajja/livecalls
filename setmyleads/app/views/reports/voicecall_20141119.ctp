     ...
     <div id = "maincontent">
          ...
          <div class = "maincenterBg" style = "clear :both">
               <div style = "margin-top: 20px; margin-bottom: 30px; margin-left: 10px;">
                    <a pass = "" href = " <?php echo $this->Html->url(array('controller' => 'api', 'action' => 'download_invoice_report', 1)) ?>"><?php echo $this->Html->image('daily.png', array('alt' => __('Daily', true), 'width' => '107', 'height' => '28'));
     ?></a>
          ...
          <table width="953" border="0">
               ...
               <?php if ($userid == 1) { ?>
                    <tr>
                         ...
                         <td>
                              <a href="#" onclick="getadminvoicecall(5);"><?php echo $this->Html->image('btn_athis_month.png', array('alt' => __('numberrange', true), 'width' => '107', 'height' => '28')); ?></a>
                              <a href="#" onclick="getadminvoicecall(6);"><?php echo $this->Html->image('btn_alast_month.png', array('alt' => __('numberrange', true), 'width' => '107', 'height' => '28')); ?></a>
                    ...
                    <tr>
                         ...
                         <td></td>
                         <td ><a href="#" onclick="getadminvoicecall(0);"><?php echo $this->Html->image('btn_asubtotal.png', array('alt' => __('numberrange', true), 'width' => '107', 'height' => '28')); ?></a>
                              <a href="#" onclick="admindownload();" ><?php echo $this->Html->image('btn_adownload.png', array('action' => 'download'), array('alt' => __('numberrange', true), 'width' => '107', 'height' => '28')); ?>
                              </a>
                              <div style="display:none;" id="links">
                                   <?php echo $this->Html->link(__('Download File', true), array('controller' => 'api/downloadsb'), array('pass' => array('export.csv'))); ?>
                              </div>
                    ...
                    <tr>
                         ...
                         <td></td>
                         <td ><a href="#" onclick="getpreadminvoicecall(0);"><?php echo $this->Html->image('subtotal-pre-3.png', array('alt' => __('numberrange', true), 'width' => '107', 'height' => '28')); ?></a>
                              <a href="#" onclick="preadmindownload();" ><?php echo $this->Html->image('download-pre-3.png', array('action' => 'download'), array('alt' => __('numberrange', true), 'width' => '107', 'height' => '28')); ?>
                              </a>
                              <div style="display:none;" id="links">
                                   <?php echo $this->Html->link(__('Download File', true), array('controller' => 'api/downloadsb'), array('pass' => array('export.csv'))); ?>
                              </div>
