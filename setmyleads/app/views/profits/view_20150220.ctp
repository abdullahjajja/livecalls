          ...
          <div >
               <div class="over01">
                    ...
                    <div class="obj01">
                         ...
                         $tp = date("d M", strtotime($profit['Profit']['date'] . "-1 month")) . ' - ' . date("d M Y", strtotime($profit['Profit']['date'] . "-1 day"));

                         // $ed = new DateTime($profit['Operator']['date']);
                         //$tp = date("d/m/y", strtotime("$ed -30 day")) . ' - ' . $ed->format('d/m/y');
                         ?>
                         <div class="obja">Report Period</div>
