          ...
          $.ajax({
               ...
               success: function(msg) {
               	...
               	for (i = 0; i < objData.length; i++) {
               		...
               		html=html+"<table width='100%' border='0' cellspacing='0' cellpadding='0'><tr class='grid1light' ><td width='50%' align='left' class='gridcellborder' style='padding-left:10px;'>"+objData[i].name +"&nbsp;</td><td width='50%' align='right' class='gridcellborder' style='padding-right:10px;'>&nbsp;"+objData[i].total+"</td></tr></table>";
          ...
          $.ajax({
               ...
               success: function(msg) {
                ...
                var totalCalls=0;
               	for (i = 0; i < objData.length; i++) {
               		totalCalls=totalCalls +  Number(objData[i].total);
               		html=html+"<table width='100%' border='0' cellspacing='0' cellpadding='0'><tr class='grid1light'><td width='50%' align='left' class='gridcellborder' style='cursor:pointer; padding-left:10px;' onclick=\"getReportByUser("+objData[i].id+",'"+objData[i].name+"')\">"+objData[i].name +"&nbsp;</td><td width='50%' align='right' style='padding-right:10px;' class='gridcellborder'>&nbsp;"+objData[i].total+"</td></tr></table>";
...
<div id="foo"></div>
 ...
 <div id="spinner"></div>
          <div id="inner">
               <div class="mainheading"><div align="left">Customer Based Report <span id="totalCustomerCalls"></span><div style="float:right; margin-right:100px;">Range Based Report <span id="totalRangeCalls"></span></div><?php echo $this->Html->link(__('LIVE CALLS', true), array('controller' => 'livecalls'), array('class' => 'livecall_link_syle')); ?></div>  </div>
                                             ...
                                             <td class="gridtable" id="tdCalls" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                       <tr>
                                                            <td class="gridtableHeader"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                      <tr>
                                                                           <td width="50%" align="left" style='padding-left:10px;'>Customer</td>
                                        ...
                                        <tr>
                                             <td class="gridtable" id="tdCalls" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                       <tr>
                                                            <td class="gridtableHeader"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                      <tr>
                                                                           <td width="50%" align="left" style='padding-left:10px;'>Name</td>
                                                                           <td width="50%" align="right" style='padding-right:10px;'>No. Of Calls</td>
