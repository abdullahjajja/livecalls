               ...
               success: function(msg) {
                ...
                var totalCalls=0;
               	for (i = 0; i < objData.length; i++) {
               		...
               		html=html+"<table width='100%' border='0' cellspacing='0' cellpadding='0'><tr class='grid1light'><td width='50%' align='center' class='gridcellborder' style='cursor:pointer;' onclick=\"getReportByOperator("+objData[i].id+",'"+objData[i].name+"')\">"+objData[i].name +"&nbsp;</td><td width='50%' align='center' class='gridcellborder'>&nbsp;"+objData[i].total+"</td></tr></table>";
