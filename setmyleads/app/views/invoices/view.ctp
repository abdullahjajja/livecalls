     ...
     <head>
          ...
          <body>
               ...
               <div class="cat01" id='temp'>
                    ...
                    <div class="btnvan2" style="background-color: #ebebeb;">
                         <?php echo $this->Html->link('Download', array('action' => 'download', $invoice['Invoice']['id']), array('style' => 'text-decoration:none')); ?>
                    </div>
                    <?php if ($r_id == 1) { ?>
          ...
          <script>
               ...
               function change_status(id, a) {
                    ...
                    //alert(id + ' ' + a);
                    $.ajax({
                         url: "<?php echo $this->Html->url(array('controller' => 'invoices', 'action' => 'ChangeInvoiceStatus')); ?>",
                         type: "GET",
                         data: "id=" + id + "&change=" + a,
                         //+ "& cld=" +called + "& clr=" +caller + "& sub=" +subcust,
