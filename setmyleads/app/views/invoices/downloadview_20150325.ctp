...
//          print_r($call);
                ...
                <div class=\"cat2\">
                     ...
                     " . $call['invoice_details']['numberrange_name'] . " </div>";
                                   ...
                                   $tp1.= "<div class = \"van02b\">" . $call['invoice_details']['minutes'];
                                   $tp1.=" </div>";

                                   $tp1.="  <div class = \"van03b\">" . $call['invoice_details']['rate'] . "
               </div>";
                                   $tp1.="  <div class=\"van02b\">" . round($tot, 2) . " </div></div>";
                              }
                         }
                         $tp1.=' </div>
                <div class="cat2c">
...
//          print_r($call);
                ...
                <div class=\"cat2\">
                     ...
                     " . $call['invoice_details']['numberrange_name'] . " </div>";
                                   ...
                                   $tp2.= "<div class = \"van02b\">" . $call['invoice_details']['minutes'];
                                   $tp2.=" </div>";

                                   $tp2.="  <div class = \"van03b\">" . $call['invoice_details']['rate'] . "
               </div>";
                                   $tp2.="  <div class=\"van02b\">" . round($tot, 2) . " </div></div>";
                              }
                         }
                         $tp2.=' </div>
                <div class="cat2c">
...
//          print_r($call);
                ...
                <div class=\"cat2\">
                     ...
                     " . $call['invoice_details']['numberrange_name'] . " </div>";
                                   ...
                                   $tp3.= "<div class = \"van02b\">" . $call['invoice_details']['minutes'];
                                   $tp3.=" </div>";

                                   $tp3.="  <div class = \"van03b\">" . $call['invoice_details']['rate'] . "
               </div>";
                                   $tp3.="  <div class=\"van02b\">" . round($tot, 2) . " </div></div>";
                              }
                         }
                         $tp3.=' </div>
                <div class="cat2c">
