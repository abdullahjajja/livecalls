...
<div id="maincontent">
     ...
     <div class="mainheading">Add New News</div>
               ...
               <tr>
                    <td align="center" valign="top"><table class="addtable">
                              ...
                              <tr>
                                   ...
                                   <td width="33%"><?php echo $this->Form->input('title', array('label' => 'Title&nbsp;&nbsp;', 'style' => 'margin-left:17px;')); ?> </td>
                              </tr>
                              <tr>
                                   <td width="33%"><?php echo $this->Form->input('detail', array('label' => 'Detail&nbsp;&nbsp;', 'class' => 'jqte-test')); ?></td>
                              </tr>
                              <tr>
