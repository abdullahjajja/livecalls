                                                       ...
                                                       foreach ($news as $news):
                                                            ...
                                                            <td <?php echo $class; ?> style="height: auto;"><table width="100%" border="0" cellspacing="0" cellpadding="10">
                                                                      ...
                                                                      <td width = "85%" style="height: auto;">
                                                                           ...
                                                                           $restult = trim($restult);
                                                                           //$restult = preg_replace("/&#?[a-z0-9]+;/i","",$restult);
                                                                          // $restult = preg_replace('/\s+/', ' ', $restult);
                                                                           // }
                                                                           ?>

                                                                           <pre style="margin-top: 0px; margin-bottom: 0px;white-space: pre-wrap;white-space: -moz-pre-wrap;white-space: -pre-wrap;white-space: -o-pre-wrap;word-wrap: break-word; "><?php echo $restult; ?></pre></td>
