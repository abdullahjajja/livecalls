...
<div id="maincontent">
     ...
     <div class="maincenterBg">
          <table width="100%" border="0" cellspacing="0" cellpadding="10">
               ...
               <tr>
                    <td><?php echo $this->Form->input('daily_title', array('options' => array('Daily 1/1' => 'Daily 1/1'))); ?></td>
                    <td ><?php echo $this->Form->input('weekly_title', array('options' => array('Weekly 7/7' => 'Weekly 7/7', 'Weekly 7/14' => 'Weekly 7/14'))); ?></td>

                    <td><?php echo $this->Form->input('monthly_title', array('options' => array('Monthly 30/30' => 'Monthly 30/30', 'Monthly 30/45' => 'Monthly 30/45'))); ?></td>
