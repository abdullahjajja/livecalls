...
<div id="maincontent">
     <div class="mainheading" ><div></div><div align="left">Number Range List</div> <div align="right" style="margin-top: -25px" ><a pass = "" href = "/api/export_numberranges" style="">Export CSV </a> <?php echo $this->Html->link(__('Import CSV', true), array('action' => 'importrange')); ?><?php echo $this->Html->link(__('Add New', true), array('action' => 'add')); ?></div> </div>
