...
<div id="maincontent">
     ...
     <a pass = "" href = "payment_terms" style="">Payment Terms </a> <a pass = "" href = "/api/export_numberranges" style="">Export CSV </a> <?php echo $this->Html->link(__('Import CSV', true), array('action' => 'importrange')); ?><?php echo $this->Html->link(__('Add New', true), array('action' => 'add')); ?></div> </div>
                                                  ...
                                                  foreach ($numberranges as $numberrange):
                                                       ...
                                                       <td <?php echo $class; ?>><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                 <tr>
                                                                      ...
                                                                      <td width="10%" align="left" class="gridcellborder">&nbsp;<?php echo $ivrname; ?></td>
                                                                      <td width="5%" align="left" class="gridcellborder">&nbsp;<?php echo $numberrange['Currency']['currency_name']; ?></td>
                                                                      <td width="5%" align="right" style="padding-right: 3px;" class="gridcellborder">&nbsp;<?php echo $numberrange['Numberrange']['buyingrate']; ?></td>
                                                                      <td width="5%" align="right" style="padding-right: 3px;" class="gridcellborder">&nbsp;<?php echo $numberrange['Numberrange']['minduraction']; ?></td>
                                                                      <td width="5%" align="right" style="padding-right: 3px;" class="gridcellborder">&nbsp;<?php echo $numberrange['Numberrange']['maxduration']; ?></td>
