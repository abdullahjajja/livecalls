...
<?php echo $this->Form->create('Didrate');?>
	<fieldset>
		<legend><?php __('Edit Didrate'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('Didrate.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('Didrate.id'))); ?></li>
