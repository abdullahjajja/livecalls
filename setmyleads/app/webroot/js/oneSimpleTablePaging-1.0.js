		...
		'oneSimpleTablePagination': function(userConfigurations) {
			...
			return this.each(function() {
				...
				function createPaginationElements() {
					var paginationHTML = "";
					paginationHTML += "<div id='tablePagination' style='text-align: center; border-top: solid 2px #2F9300; padding-top: 5px; padding-bottom: 5px;'>";
