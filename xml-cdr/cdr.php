<?php
  ...
  fclose($fh);*/
	...
	$hangup_cause=urldecode($cdr[variables]['hangup_cause']);
        $custom_hangup_cause=urldecode($cdr[variables]['custom_hangup_cause']);
 ...
 // $query="INSERT INTO cdrs VALUES (".join(",",$fields).")";
   $query="INSERT INTO cdrs (caller_id_name, caller_id_number, destination_number, context, start_stamp, answer_stamp, end_stamp, duration, billsec, hangup_cause, uuid, bleg_uuid, accountcode, superresseler_id, resseller_id, subresseller_id, numberrange_name, Addon, superresrate, ressellerrate, subresrate, currency_id, admin_currency, supres_currency, reseller_currency, subres_currency,isdaily,operator_name,payment_term,operator_ip,adminbuyrate,sip_local_network_addr) VALUES (".'"'.$caller_id_name.'"'.",".'"'.$caller_id_number.'"'.",".'"'.$destination_number.'"'.",".'"'.$context.'"'.",".'"'.$start_stamp.'"'.",".'"'.$answer_stamp.'"'.",".'"'.$end_stamp.'"'.",".'"'.$duration.'"'.",".'"'.$billsec.'"'.",".'"'.$hangup_cause.'"'.",".'"'.$uuid.'"'.",".'"'.$bleg_uuid.'"'.",".'"'.$accountcode.'"'.",".'"'.$SuperResseler_ID.'"'.",".'"'.$Resseller_ID.'"'.",".'"'.$Subresseller_ID.'"'.",".'"'.$numberrange_name.'"'.",".'"'.$Addone.'"'.",".'"'.$superresrate.'"'.",".'"'.$ressellerrate.'"'.",".'"'.$subresrate.'"'.",".'"'.$currency_id.'"'.",".'"'.$admin_currency.'"'.",".'"'.$supres_currency.'"'.",".'"'.$reseller_currency.'"'.",".'"'.$subres_currency.'"'.",".'"'.$isdaily.'"'.",".'"'.$operator_name.'"'.",".'"'.$payment_term.'"'.",".'"'.$operator_ip.'"'.",".'"'.$adminbuyrate.'"'.",".'"'.$sip_local_network_addr.'"'.")";
   
   ///////// CDR for DIDs Not matching
	$query_nomatch="INSERT INTO unmatch_did_cdrs (caller_id_name, caller_id_number, destination_number, context, start_stamp, answer_stamp, end_stamp, duration, billsec, hangup_cause, uuid, bleg_uuid, accountcode, superresseler_id, resseller_id, subresseller_id, numberrange_name, Addon, superresrate, ressellerrate, subresrate, currency_id, admin_currency, supres_currency, reseller_currency, subres_currency,isdaily,operator_name,payment_term,operator_ip,adminbuyrate,custom_hangup_cause) VALUES (".'"'.$caller_id_name.'"'.",".'"'.$caller_id_number.'"'.",".'"'.$destination_number.'"'.",".'"'.$context.'"'.",".'"'.$start_stamp.'"'.",".'"'.$answer_stamp.'"'.",".'"'.$end_stamp.'"'.",".'"'.$duration.'"'.",".'"'.$billsec.'"'.",".'"'.$hangup_cause.'"'.",".'"'.$uuid.'"'.",".'"'.$bleg_uuid.'"'.",".'"'.$accountcode.'"'.",".'"'.$SuperResseler_ID.'"'.",".'"'.$Resseller_ID.'"'.",".'"'.$Subresseller_ID.'"'.",".'"'.$numberrange_name.'"'.",".'"'.$Addone.'"'.",".'"'.$superresrate.'"'.",".'"'.$ressellerrate.'"'.",".'"'.$subresrate.'"'.",".'"'.$currency_id.'"'.",".'"'.$admin_currency.'"'.",".'"'.$supres_currency.'"'.",".'"'.$reseller_currency.'"'.",".'"'.$subres_currency.'"'.",".'"'.$isdaily.'"'.",".'"'.$operator_name.'"'.",".'"'.$payment_term.'"'.",".'"'.$operator_ip.'"'.",".'"'.$adminbuyrate.'"'.",".'"'.$custom_hangup_cause.'"'.")";
...
$query_delete_from_channels_table="delete from channels where uuid='$uuid'";	
  $con = mysql_connect("108.178.8.204","root","r5dh@t");
  if (!$con)
  {
